...
$message="<font color=red>Please login.</font>";
...
break;
case 'Manager':
$rsql="SELECT manager_id, first_name,last_name,staff_id,username FROM manager WHERE username='$username' AND password='$password'";
...
<div id="main" style="color: #0000FF">
