...
<hr/>	
    <div class="tabbed_area">  
       ...
       $result = mysqli_query($conn,"SELECT * FROM prescription")or die(mysql_error());
		// display data in table
        echo "<table border='1' cellpadding='5'align='center'>";
        echo "<tr> <th>Customer</th><th>Prescription No.</sup></th> <th>Invoice No.</sup></th><th>Date </th><th>Delete</th></tr>";
